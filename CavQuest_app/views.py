...
def user_profile(request):
    ...
    if (request.user.username == "cs3240.super" \
            or request.user.email == "xqj8fz@virginia.edu" or request.user.email == "umm9ef@virginia.edu"
            or request.user.email == "zw4re@virginia.edu"
            or  request.user.email=="nicole.savage00@gmail.com" \
            or request.user.email == "ufx2ju@virginia.edu" or request.user.email == "dch6auf@virginia.edu"):
...
def congratulations(request, task_id):
    ...
    return render(request, 'CavQuest_app/congratulations.html', {'task': task, 'place': place, 'facts': facts})
